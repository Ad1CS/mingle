  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 antialiased">
      ...
      <div className="w-full max-w-md bg-surface p-8 rounded-2xl shadow-sm border border-outline-variant">
        <h1 className="font-headline-sm text-headline-sm text-on-surface mb-2">Welcome back</h1>
        <p className="font-body-md text-on-surface-variant mb-6">Log in to continue your journey.</p>
        ...
        <div className="mt-6 text-center">
          <p className="text-on-surface-variant font-body-md text-sm">
            Don't have an account? <Link to="/register" className="text-primary font-medium hover:underline">Join Mingle</Link>
          </p>
        </div>
      </div>
    </div>
